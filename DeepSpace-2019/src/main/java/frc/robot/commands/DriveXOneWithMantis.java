 ...
 */
public class DriveXOneWithMantis extends Command {

	/**
	 * Continuously drive the robot via Arcade Drive
	 */
	public DriveXOneWithMantis() {
		requires(Robot.drive);
	}

	@Override
	protected void execute() {
		Robot.drive.arcadeDriveWithMantis(Robot.oi.getDriverAxis(Axis.LEFT_Y), Robot.oi.getDriverAxis(Axis.LEFT_X)); //Poll driver's left axes to drive
	}
